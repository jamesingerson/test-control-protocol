...
- `NORMAL`/`CR TEST`/`CR CRS`/`CR REQ`/`CR COM`/`GROUP` operands with no matching `A`/`M`/`N`/`R`/`S`/`H` data declaration (a warning, not an error — see below)
